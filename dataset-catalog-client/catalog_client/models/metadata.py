...
class OntologyEntry(BaseModel):
    ...
    label: str | None = Field(default=None, description="Human-readable name or label for the ontology term")
...
class TissueEntry(OntologyEntry):
    ...
    type: str | None = Field(
        default=None,
        description="Additional tissue type classification (e.g., 'organelle', 'cell line', 'tissue', 'organoid')",
    )
...
class SampleMetadata(BaseModel):
    ...
    tissue: list[TissueEntry] | None = Field(default=None, description="Tissue(s) from which the sample was derived")
...
class ExperimentMetadata(BaseModel):
    ...
    sub_modality: str | None = Field(default=None, description="Specific sub-type within the main data modality")
    assay: list[OntologyEntry] | None = Field(default=None, description="Assay(s) or experimental technique(s) used")
...
class ResolutionMetadata(BaseModel):
    ...
    spatial: dict[str, Any] | None = Field(default=None, description="Spatial resolution information")
    temporal: dict[str, Any] | None = Field(default=None, description="Temporal resolution information")
...
class DataSummaryMetadata(BaseModel):
    ...
    read_count: int | None = Field(default=None, description="Number of reads or sequences (for sequencing data)")
    read_length: int | dict[str, int] | None = Field(
        default=None, description="Length of reads in base pairs (for sequencing data)"
    )
    read_confidence: float | None = Field(default=None, description="Quality score or confidence measure for reads")
    ...
    well: str | list[str] | None = Field(default=None, description="Well identifier for plate-based experiments")
    fov: str | list[str] | None = Field(default=None, description="Field of view identifier for imaging experiments")
...
class DatasetMetadata(BaseModel):
    ...
    experiment: ExperimentMetadata | None = Field(default=None, description="Experimental design and protocol metadata")
