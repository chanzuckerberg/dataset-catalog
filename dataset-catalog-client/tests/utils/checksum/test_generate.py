...
def test_s3_file_stored_checksum_returned_without_download(mock_fetch, mock_s3):
    ...
    with patch("catalog_client.utils.checksum.generate.compute_checksum_s3") as mock_compute:
...
def test_s3_folder_explicit_algo_matching_children_compute_flag_true_uses_stored(mock_find, mock_compute, mock_s3):
...
def test_s3_folder_explicit_algo_matching_children_compute_flag_false_uses_stored(mock_find, mock_compute, mock_s3):
...
@patch("catalog_client.utils.checksum.generate._fetch_all_s3_stored_checksums", return_value={})
@patch("catalog_client.utils.checksum.generate.compute_checksum_s3", side_effect=Exception("NoCredentialsError"))
...
@patch("catalog_client.utils.checksum.generate._fetch_all_s3_stored_checksums", return_value={})
@patch("catalog_client.utils.checksum.generate.compute_checksum_s3", side_effect=PermissionError("Access denied"))
